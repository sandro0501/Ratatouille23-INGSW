...
--
-- Table structure for table `listaallergeni`
--

DROP TABLE IF EXISTS `listaallergeni`;
...
--
-- Dumping data for table `listaallergeni`
--

LOCK TABLES `listaallergeni` WRITE;
/*!40000 ALTER TABLE `listaallergeni` DISABLE KEYS */;
/*!40000 ALTER TABLE `listaallergeni` ENABLE KEYS */;
UNLOCK TABLES;
