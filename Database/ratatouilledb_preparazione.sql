...
CREATE TABLE `preparazione` (
  ...
  `quantitàNecessaria` double NOT NULL,
  KEY `prodottoPreparazione_idx` (`prodottoAssociato`),
  KEY `elementoPreparazione_idx` (`elementoAssociato`),
  CONSTRAINT `elementoPreparazione` FOREIGN KEY (`elementoAssociato`) REFERENCES `elemento` (`idElemento`),
  CONSTRAINT `prodottoPreparazione` FOREIGN KEY (`prodottoAssociato`) REFERENCES `prodotto` (`idProdotto`)
