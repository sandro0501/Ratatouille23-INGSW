...
CREATE TABLE `dispensa` (
  ...
  `ristoranteAssociato` int NOT NULL,
  `soglia` double NOT NULL,
  `quantità` double NOT NULL,
  KEY `prodottoDispensa_idx` (`prodottoAssociato`),
  KEY `ristoranteDispesna_idx` (`ristoranteAssociato`),
  CONSTRAINT `prodottoDispensa` FOREIGN KEY (`prodottoAssociato`) REFERENCES `prodotto` (`idProdotto`),
  CONSTRAINT `ristoranteDispesna` FOREIGN KEY (`ristoranteAssociato`) REFERENCES `ristorante` (`idRistorante`)
...
-- Dump completed on 2022-12-27 19:29:36
