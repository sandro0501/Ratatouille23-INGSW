...
--
-- Table structure for table `sezionemenu`
--

DROP TABLE IF EXISTS `sezionemenu`;
...
--
-- Dumping data for table `sezionemenu`
--

LOCK TABLES `sezionemenu` WRITE;
/*!40000 ALTER TABLE `sezionemenu` DISABLE KEYS */;
/*!40000 ALTER TABLE `sezionemenu` ENABLE KEYS */;
UNLOCK TABLES;
