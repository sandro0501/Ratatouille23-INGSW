...
public class BachecaActivity extends AppCompatActivity {
    ...
    private void inizializzaMenu() {
        ...
        Utente utenteLoggato = new Addetto("Genoveffa", "Arcobaleno", "genoveffa@mail.it", ruoliPersonale.addettoAllaCucina);
        //Utente utenteLoggato = new Amministratore("Mario", "Rossi", "mario@mail.it", false);
